...
public class ServerConfig{
	...
	@ConfigRange( min = 0, max = 1000000.0 )
	@ConfigOption( side = ConfigSide.SERVER, category = {"growth", "standard_dragon"}, key = "rangeBonus", comment = "The bonus that is given to dragons at 60 size. The bonus gradually scales up to the maximum size. Human players have 1.0x attack range and a size 60 dragon will have 1.5x attack range with default values.")
	public static Double rangeBonus = 0.5;
	...
	public static List<String> allowedVehicles = List.of("minecraft:player", "minecraft:boat", "littlelogistics:seater_barge", "minecraft:minecart", "create:seat", "create:contraption", "create:gantry_contraption", "create:stationary_contraption", "hexerei:broom", "botania:player_mover", "quark:quark_boat");
