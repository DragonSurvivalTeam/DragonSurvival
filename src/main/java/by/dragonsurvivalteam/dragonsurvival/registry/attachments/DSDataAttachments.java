...
public class DSDataAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<EffectModifications>> EFFECT_MODIFICATIONS = DS_ATTACHMENT_TYPES.register("effect_modifications", () -> AttachmentType.serializable(EffectModifications::new).build());
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<BlockVisionData>> BLOCK_VISION = DS_ATTACHMENT_TYPES.register("block_vision_data", () -> AttachmentType.serializable(BlockVisionData::new).build());
}
