...
public class DSDataAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<FlightData>> SPIN = REGISTRY.register("spin_data", () -> AttachmentType.serializable(FlightData::new).copyOnDeath().build());
