...
public class DSDataAttachments {
    ...
    // Not serialized since we don't want to retain these effects after logout e.g. (usually there should not be any left after the next tick anyway)
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<SwimData>> SWIM = REGISTRY.register("swim_data", () -> AttachmentType.serializable(SwimData::new).build());
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<GlowData>> GLOW = REGISTRY.register("glow_data", () -> AttachmentType.serializable(GlowData::new).build());
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<ClimbableData>> CLIMBABLE_DATA = REGISTRY.register("climbable_data", () -> AttachmentType.serializable(ClimbableData::new).build());
