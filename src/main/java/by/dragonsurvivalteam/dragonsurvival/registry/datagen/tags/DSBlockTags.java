...
public class DSBlockTags extends BlockTagsProvider {
    ...
    protected void addTags(@NotNull final HolderLookup.Provider provider) {
        ...
        tag(SMALL_WOODEN_DRAGON_DOORS)
                .add(DSBlocks.SMALL_OAK_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_SPRUCE_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_ACACIA_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_BIRCH_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_JUNGLE_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_DARK_OAK_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_WARPED_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_CRIMSON_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_FOREST_DRAGON_DOOR.get());
    ...
    private void addToVanillaTags() {
        tag(BlockTags.MINEABLE_WITH_AXE)
                ...
                .add(DSBlocks.OAK_DRAGON_ALTAR.get())
                .add(DSBlocks.BIRCH_DRAGON_ALTAR.get())
                .add(DSBlocks.PALE_OAK_DRAGON_ALTAR.get())
                .add(DSBlocks.CRIMSON_DRAGON_ALTAR.get())
                .add(DSBlocks.WARPED_DRAGON_ALTAR.get())
                .add(DSBlocks.MANGROVE_DRAGON_ALTAR.get())
                .add(DSBlocks.BAMBOO_DRAGON_ALTAR.get())
                .add(DSBlocks.CHERRY_DRAGON_ALTAR.get())
                .add(DSBlocks.ACACIA_DRAGON_ALTAR.get())
                .add(DSBlocks.DARK_OAK_DRAGON_ALTAR.get())
                .add(DSBlocks.JUNGLE_DRAGON_ALTAR.get())
                .add(DSBlocks.SPRUCE_DRAGON_ALTAR.get())
                .addTag(SMALL_WOODEN_DRAGON_DOORS)
                .add(DSBlocks.FOREST_DRAGON_PRESSURE_PLATE.get());

        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(DSBlocks.STONE_DRAGON_ALTAR.get())
                .add(DSBlocks.SANDSTONE_DRAGON_ALTAR.get())
                .add(DSBlocks.RED_SANDSTONE_DRAGON_ALTAR.get())
                .add(DSBlocks.PURPUR_DRAGON_ALTAR.get())
                .add(DSBlocks.NETHER_BRICK_DRAGON_ALTAR.get())
                .add(DSBlocks.MOSSY_DRAGON_ALTAR.get())
                .add(DSBlocks.BLACKSTONE_DRAGON_ALTAR.get())
                .add(DSBlocks.BONE_DRAGON_ALTAR.get())
                .add(DSBlocks.QUARTZ_DRAGON_ALTAR.get())
                .add(DSBlocks.ICE_DRAGON_ALTAR.get())
                .add(DSBlocks.NETHERRACK_DRAGON_ALTAR.get())
                .add(DSBlocks.OBSIDIAN_DRAGON_ALTAR.get())
                .add(DSBlocks.AMETHYST_DRAGON_ALTAR.get())
                .add(DSBlocks.MUDBRICK_DRAGON_ALTAR.get())
                .add(DSBlocks.PRISMARINE_DRAGON_ALTAR.get())
                .add(DSBlocks.RED_NETHER_BRICK_DRAGON_ALTAR.get())
                .add(DSBlocks.ENDSTONE_DRAGON_ALTAR.get())
                .add(DSBlocks.DEEPSLATE_DRAGON_ALTAR.get())
                .add(DSBlocks.TUFF_DRAGON_ALTAR.get())
                .add(DSBlocks.CAVE_DRAGON_DOOR.get())
                .add(DSBlocks.SEA_DRAGON_DOOR.get())
                .add(DSBlocks.IRON_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_STONE_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_GOTHIC_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_CAVE_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_SEA_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_IRON_DRAGON_DOOR.get())
                .add(DSBlocks.SMALL_SKYRIM_DRAGON_DOOR.get())
                .add(DSBlocks.SKYRIM_DRAGON_DOOR.get())
                .add(DSBlocks.GOTHIC_DRAGON_DOOR.get())
                .add(DSBlocks.STONE_DRAGON_DOOR.get())
                .add(DSBlocks.CAVE_SOURCE_OF_MAGIC.get())
                .add(DSBlocks.FOREST_SOURCE_OF_MAGIC.get())
                .add(DSBlocks.SEA_SOURCE_OF_MAGIC.get())
                .add(DSBlocks.DEBRIS_DRAGON_TREASURE.get())
                .add(DSBlocks.DIAMOND_DRAGON_TREASURE.get())
                .add(DSBlocks.EMERALD_DRAGON_TREASURE.get())
                .add(DSBlocks.COPPER_DRAGON_TREASURE.get())
                .add(DSBlocks.GOLD_DRAGON_TREASURE.get())
                .add(DSBlocks.IRON_DRAGON_TREASURE.get())
                .add(DSBlocks.GRAY_KNIGHT_HELMET.get())
                .add(DSBlocks.GOLDEN_KNIGHT_HELMET.get())
                .add(DSBlocks.BLACK_KNIGHT_HELMET.get())
                ...
                .add(DSBlocks.SEA_DRAGON_PRESSURE_PLATE.get())
                .add(DSBlocks.CAVE_DRAGON_PRESSURE_PLATE.get());
