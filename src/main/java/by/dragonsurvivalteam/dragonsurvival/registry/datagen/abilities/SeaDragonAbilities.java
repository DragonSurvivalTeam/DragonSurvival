...
public class SeaDragonAbilities {
        ...
        context.register(ORE_GLOW, new DragonAbility(
                ...
                List.of(new ActionContainer(new AreaTarget(AbilityTargeting.entity(List.of(
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("diamond_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                                        .blocks(context.lookup(Registries.BLOCK).getOrThrow(Tags.Blocks.ORES_DIAMOND))
                                        .range(LevelBasedValue.constant(36))
                                        .displayType(BlockVision.DisplayType.PARTICLES)
                                        .colors(List.of(
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("lapis_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("gold_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("redstone_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("coal_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("emerald_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                        DurationInstanceBase.create(DragonSurvival.res("quartz_vision"))
                                                .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                .hidden().build())
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("copper_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("netherite_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                        .hidden().build()
                                        )
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                        DurationInstanceBase.create(DragonSurvival.res("iron_vision"))
                                                .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                                                .hidden().build())
                        ...
                        BlockVisionEffect.single(BlockVision.create(
                                                DurationInstanceBase.create(DragonSurvival.res("general_ore_vision"))
                                                        .duration(LevelBasedValue.perLevel(Functions.secondsToTicks(260)))
                ...
                List.of(new ActionContainer(new AreaTarget(AbilityTargeting.entity(
                        List.of(
                                ModifierEffect.single(new ModifierWithDuration(
                                        ...
                                        List.of(Modifier.per(DSAttributes.EXPERIENCE, 0.5f, AttributeOperation.ADD_VALUE))
                                )),
                                new ParticleEffect(
    ...
    private static void registerPassiveAbilities(final BootstapContext<DragonAbility> context) {
                ...
                List.of(
                        new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                                ModifierEffect.only(new ModifierWithDuration(
                                        DurationInstanceBase.create(DragonSurvival.res("sea_magic")).removeAutomatically().hidden().build(),
                        ...
                        new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                                ...
                                ModifierEffect.only(new ModifierWithDuration(
                                        ...
                                        List.of(Modifier.per(DSAttributes.MANA_REGENERATION, 0.02f, AttributeOperation.ADD_VALUE))
                                )),
                                TargetingMode.ALLIES_AND_SELF
                        )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1))
                ),
        ...
        context.register(HYDRATION, new DragonAbility(
                ...
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        ModifierEffect.only(new ModifierWithDuration(
                                DurationInstanceBase.create(DragonSurvival.res("dry_resilience")).removeAutomatically().hidden().build(),
                                List.of(Modifier.per(DSAttributes.PENALTY_RESISTANCE_TIME, Functions.secondsToTicks(60), AttributeOperation.ADD_VALUE))
                        )),
                        TargetingMode.ALLIES_AND_SELF
                )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1))),
                true,
        ...
        context.register(SPECTRAL_IMPACT, new DragonAbility(
                ...
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        ModifierEffect.only(new ModifierWithDuration(
                                DurationInstanceBase.create(DragonSurvival.res("spectral_impact")).removeAutomatically().hidden().build(),
                                List.of(Modifier.per(DSAttributes.ARMOR_IGNORE_CHANCE, 0.15f, AttributeOperation.ADD_VALUE))
                        )),
                        TargetingMode.ALLIES_AND_SELF
                )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1))),
                true,
        ...
        context.register(ELECTRIC_IMMUNITY, new DragonAbility(
                ...
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        DamageModificationEffect.only(new DamageModification(
                                DurationInstanceBase.create(DragonSurvival.res("electric_immunity")).removeAutomatically().customIcon(DragonSurvival.res("textures/ability_effect/electric_immunity.png")).build(),
        ...
        context.register(AMPHIBIOUS, new DragonAbility(
                ...
                List.of(
                        new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                                List.of(new SwimEffect(LevelBasedValue.constant(SwimData.UNLIMITED_OXYGEN), LevelBasedBoolean.atLevel(true, 2), ForgeMod.WATER_TYPE.getHolder().orElseThrow())),
                                TargetingMode.ALL
                        )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1)),
                        new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                                ModifierEffect.only(new ModifierWithDuration(
                                        DurationInstanceBase.create(DragonSurvival.res("amphibious")).removeAutomatically().hidden().build(),
                                        List.of(Modifier.constant(ForgeMod.SWIM_SPEED, 1, AttributeOperation.ADD_VALUE))
                                )),
                                TargetingMode.ALL
                        )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1)),
                        new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                                ModifierEffect.only(new ModifierWithDuration(
                                        ...
                                        List.of(Modifier.constant(DSAttributes.PENALTY_RESISTANCE_TIME, Functions.secondsToTicks(60), AttributeOperation.ADD_VALUE))
                                )),
                                TargetingMode.ALL
                        )), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1))
                ),
