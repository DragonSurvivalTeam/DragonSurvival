...
public class DSRecipes extends RecipeProvider {
    public DSRecipes(HolderLookup.Provider registries, RecipeOutput output) {
    ...
    protected void buildRecipes() {
        ...
        // TODO :: Not sure if clearTags should be true or false here
        registry.unfreeze(true);

        buildShaped(output, registries);
        buildShapeless(output, registries);
    ...
    private void buildShaped(final RecipeOutput output, final HolderLookup.Provider lookup) {
        this.shaped(RecipeCategory.MISC, DSItems.ELDER_DRAGON_HEART.value())
                .pattern("DGD")
                .pattern("GHG")
                .pattern("NGN")
        ...
        this.shaped(RecipeCategory.FOOD, DSItems.CAVE_DRAGON_TREAT.value())
                .pattern("DDD")
                .pattern("DCD")
                .pattern("DDD")
        ...
        this.shaped(RecipeCategory.FOOD, DSItems.CHARGED_COAL.value())
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, DragonSurvival.res("charged_coal_from_dust")));
        ...
        this.shaped(RecipeCategory.FOOD, DSItems.CHARGED_COAL.value())
                ...
                .save(output.withConditions(new ModLoadedCondition("regions_unexplored")),  ResourceKey.create(Registries.RECIPE, DragonSurvival.res("charged_coal_from_bulb")));
    }
    ...
    private void buildShapeless(final RecipeOutput output, final HolderLookup.Provider lookup) {
        ...
        this
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, DragonSurvival.res("charcoal_from_charred_food")));
    ...
    private void buildDragonTreasures(final RecipeOutput output, final HolderLookup.Provider lookup) {
        ...
        this
                ...
                .save(output, ResourceKey.create(Registries.RECIPE, DragonSurvival.res("elder_dragon_dust_from_dragon_treasures")));
    }
