...
public class CaveDragonAbilities {
                ...
                List.of(
                        new ActionContainer(new DragonBreathTarget(AbilityTargeting.entity(
                                ...
                                List.of(
                                        ...
                                        PotionEffect.single(LevelBasedValue.constant(0), LevelBasedValue.constant(Functions.secondsToTicks(10)), LevelBasedValue.constant(0.3f), false, DSEffects.BURN)
                                ),
    ...
    private static void registerPassiveAbilities(final BootstrapContext<DragonAbility> context) {
        ...
        context.register(BURN, new DragonAbility(
                ...
                Optional.empty(),
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        List.of(new OnAttackEffect(PotionData.of(LevelBasedValue.constant(0), LevelBasedValue.perLevel(Functions.secondsToTicks(5)), LevelBasedValue.perLevel(0.15f), false, DSEffects.BURN))),
                        TargetingMode.ALL
                )), LevelBasedValue.constant(1))),
                true,
                new LevelBasedResource(List.of(
        ...
        context.register(CAVE_CLAWS_AND_TEETH, new DragonAbility(
                ...
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        HarvestBonusEffect.only(new HarvestBonus(
                                DurationInstanceBase.create(DragonSurvival.res("cave_claws_and_teeth")).infinite().removeAutomatically().customIcon(DragonSurvival.res("textures/ability_effect/cave_claw.png")).hidden().build(),
