...
public class DSAttributes {
    ...
    public static final Holder<Attribute> PENALTY_RESISTANCE_TIME = DS_ATTRIBUTES.register("penalty_resistance_time", () -> new TimeAttribute(Translation.Type.ATTRIBUTE.wrap("penalty_resistance_time"), Functions.secondsToTicks(10), 0, 16384).setSyncable(true));
