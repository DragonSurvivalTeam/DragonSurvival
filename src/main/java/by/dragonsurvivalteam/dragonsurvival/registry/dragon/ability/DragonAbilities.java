...
public class DragonAbilities {
    ...
    public static void registerAbilities(final BootstapContext<DragonAbility> context) {
                        ...
                        ClimbEffect.only(new Climbable(
                                ...
                                LevelBasedBlockPredicate.constant(
                                        BlockPredicate.allOf(
                                                BlockPredicate.not(BlockPredicate.matchesBlocks(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR)),
                                                BlockPredicate.noFluid(),
                                                BlockPredicate.not(BlockPredicate.matchesTag(BlockTags.ICE)),
                                                BlockPredicate.not(BlockPredicate.matchesTag(Tags.Blocks.GLASS)),
        ...
        context.register(ResourceKey.create(DragonAbility.REGISTRY, DragonSurvival.res(TEST_PREFIX + "entity_projectile")), new DragonAbility(
        ...
        context.register(ResourceKey.create(DragonAbility.REGISTRY, DragonSurvival.res(TEST_PREFIX + "reserve_mana")), new DragonAbility(
                ...
                List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(
                        DamageModificationEffect.only(new DamageModification(
                                DurationInstanceBase.create(DragonSurvival.res(TEST_PREFIX + "reserve_mana")).removeAutomatically().build(),
                                Optional.empty(),
                                LevelBasedValue.constant(0.5f)
                        )),
                        TargetingMode.ALL
