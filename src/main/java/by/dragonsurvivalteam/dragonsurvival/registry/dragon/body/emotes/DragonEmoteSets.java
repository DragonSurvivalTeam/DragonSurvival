        ...
        context.register(DEFAULT_EMOTES,
                new DragonEmoteSet(
                        List.of(
                                ...
                                DragonEmote.Builder.of(BLEND_HEAD_LOCKED, SOUND_PURR).sound(SoundEvents.CAT_PURR_BABY.value(), 160, 1.5f, 0.8f).blend().build(),
                                DragonEmote.Builder.of(BLEND_HEAD_LOCKED, SOUND_PURREOW).sound(SoundEvents.CAT_PURREOW_BABY.value(), 160, 2.0f, 0.3f).blend().build(),
                                DragonEmote.Builder.of(BLEND_TALK, SOUND_STRAY_AMBIENT).speed(0.1).sound(SoundEvents.CAT_STRAY_AMBIENT_BABY.value(), 160, 2.0f, 0.2f).blend().build(),
                                DragonEmote.Builder.of(BLEND_BREATH, SOUND_ROAR).speed(0.1).sound(SoundEvents.ENDER_DRAGON_GROWL, 160, 0.3f, 0.1f).blend().build(),
                                DragonEmote.Builder.of(BLEND_BREATH, SOUND_HISS).speed(0.2).sound(SoundEvents.CAT_HISS_BABY.value(), 160, 1.5f, 0.2f).blend().build(),
                                // FIXME :: This used to be WOLF_GROWL, but WOLF_GROWL doesn't exist anymore
                                DragonEmote.Builder.of(BLEND_SPELL_CHARGE, SOUND_GROWL).speed(0.001).sound(SoundEvents.ENDER_DRAGON_GROWL, 160, 1.0f, 0.2f).blend().build(),
