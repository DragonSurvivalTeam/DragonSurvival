...
public record DamagePenalty(Holder<DamageType> damageType, float damage) implements PenaltyEffect {
    ...
    public MutableComponent getDescription() {
        ...
        MutableComponent translation = Component.translatable(Translation.Type.DAMAGE_TYPE.wrap(damageType.unwrapKey().orElseThrow().location())).withColor(DSColors.GOLD);
