...
public record DamagePenalty(Holder<DamageType> damageType, float damage) implements PenaltyEffect {
    ...
    public MutableComponent getDescription() {
        ...
        MutableComponent translation = DSColors.withColor(Component.translatable(Translation.Type.DAMAGE_TYPE.wrap(damageType.unwrapKey().orElseThrow().location())), DSColors.GOLD);
