...
public class DSConditions {
    public static final DeferredRegister<MapCodec<? extends ICondition>> REGISTRY = DeferredRegister.create(ForgeRegistries.Keys.CONDITION_CODECS, DragonSurvival.MODID);
