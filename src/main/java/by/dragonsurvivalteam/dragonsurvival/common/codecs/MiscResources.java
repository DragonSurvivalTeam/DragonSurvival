...
public record MiscResources(
        Optional<Identifier> foodSprites,
        Optional<ManaSprites> manaSprites,
        Identifier altarBanner,
        Identifier castBar,
        ...
        Optional<Component> customGrowthInfo
) {
    public static final Codec<MiscResources> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.optionalFieldOf("food_sprites").forGetter(MiscResources::foodSprites),
            ManaSprites.CODEC.optionalFieldOf("mana_sprites").forGetter(MiscResources::manaSprites),
            Identifier.CODEC.fieldOf("altar_banner").forGetter(MiscResources::altarBanner),
            Identifier.CODEC.fieldOf("ability_bar").forGetter(MiscResources::castBar), // TODO :: could have a simple cast bar without a dragon as default
            ...
            ComponentSerialization.CODEC.optionalFieldOf("custom_growth_info").forGetter(MiscResources::customGrowthInfo)
    ).apply(instance, MiscResources::new));

    public record HoverIcon(Identifier hoverIcon, Identifier icon) {
        ...
        public static final Codec<HoverIcon> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Identifier.CODEC.fieldOf("hover_icon").forGetter(HoverIcon::hoverIcon),
                Identifier.CODEC.fieldOf("icon").forGetter(HoverIcon::icon)
        ).apply(instance, HoverIcon::new));
    }

    public record FillIcon(Identifier empty, Identifier full) {
        public static final Codec<FillIcon> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Identifier.CODEC.fieldOf("empty").forGetter(FillIcon::empty),
                Identifier.CODEC.fieldOf("full").forGetter(FillIcon::full)
        ).apply(instance, FillIcon::new));
    }

    public record ManaSprites(Identifier full, Identifier reserved, Identifier recovery, Identifier empty) {
        ...
        public static final Codec<ManaSprites> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Identifier.CODEC.fieldOf("full").forGetter(ManaSprites::full),
                Identifier.CODEC.fieldOf("reserved").forGetter(ManaSprites::reserved),
                Identifier.CODEC.fieldOf("recovery").forGetter(ManaSprites::recovery),
                Identifier.CODEC.fieldOf("empty").forGetter(ManaSprites::empty)
        ).apply(instance, ManaSprites::new));
    }

    public record FoodTooltip(Identifier font, String nutritionIcon, String saturationIcon, Optional<TextColor> color) {
        public static final Identifier DEFAULT_FOOD_TOOLTIP_FONT = DragonSurvival.res("food_tooltip_icon_font");

        public static final Codec<FoodTooltip> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Identifier.CODEC.optionalFieldOf("font", DEFAULT_FOOD_TOOLTIP_FONT).forGetter(FoodTooltip::font),
