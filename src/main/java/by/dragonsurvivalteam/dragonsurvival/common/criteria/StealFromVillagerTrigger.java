...
public class StealFromVillagerTrigger extends DragonCriterionTrigger<StealFromVillagerTrigger.Instance> {
    public StealFromVillagerTrigger() {
        super(DragonSurvival.res("steal_from_villager"));
    }
    ...
    public static class Instance extends DragonCriterionTrigger.Instance {
        public Instance(final Optional<ContextAwarePredicate> player) {
            super(DragonSurvival.res("steal_from_villager"), player);
        }
    }
}
