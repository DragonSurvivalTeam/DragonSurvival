...
public abstract class Hunter extends PathfinderMob implements GeoEntity, ConfigurableAttributes {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Monster.class, 0, false, false, (living, serverLevel) -> living.getType().is(DSEntityTypeTags.HUNTER_TARGETS)));
