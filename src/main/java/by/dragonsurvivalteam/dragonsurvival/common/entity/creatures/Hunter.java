...
public abstract class Hunter extends PathfinderMob implements GeoEntity, ConfigurableAttributes {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(@NotNull final ServerLevelAccessor level, @NotNull final DifficultyInstance difficulty, @NotNull final EntitySpawnReason spawnType, @Nullable final SpawnGroupData spawnGroupData) {
        setAttributes();
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Player.class, 0, true, false, (living, serverLevel) -> living.hasEffect(DSEffects.HUNTER_OMEN)));
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Monster.class, 0, false, false, (living, serverLevel) -> living.getType().builtInRegistryHolder().is(DSEntityTypeTags.HUNTER_TARGETS)));
