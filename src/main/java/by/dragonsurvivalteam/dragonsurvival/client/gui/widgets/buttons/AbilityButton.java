...
public class AbilityButton extends ExtendedButton {
    public static final ResourceLocation ACTIVE_BACKGROUND = new ResourceLocation(DragonSurvival.MODID, "ability_screen/skill_main");
    public static final ResourceLocation PASSIVE_BACKGROUND = new ResourceLocation(DragonSurvival.MODID, "ability_screen/skill_main");
    public static final ResourceLocation DISABLED_BACKGROUND = new ResourceLocation(DragonSurvival.MODID, "ability_screen/skill_disabled");
    public static final ResourceLocation AUTO_UPGRADE_ORNAMENTATION = new ResourceLocation(DragonSurvival.MODID, "ability_screen/skill_autoupgrade");
