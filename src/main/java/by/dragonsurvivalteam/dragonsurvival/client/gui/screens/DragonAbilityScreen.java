...
public class DragonAbilityScreen extends Screen {
    ...
    private static final Identifier EXPERIENCE_FOR_MANA_TOGGLE_ON = Identifier.fromNamespaceAndPath(MODID, "textures/gui/ability_screen/exp_conv_on.png");
    private static final Identifier EXPERIENCE_FOR_MANA_TOGGLE_OFF = Identifier.fromNamespaceAndPath(MODID, "textures/gui/ability_screen/exp_conv_off.png");
    ...
    public void init() {
        ...
        ExtendedButton experienceManaConversion = new ExtendedButton(guiLeft + 196, startY + 263 / 2 + 25, 14, 14, Component.empty(), button -> {
            ...
            public void extractWidgetRenderState(@NotNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
                graphics.blit(RenderPipelines.GUI_TEXTURED, data.usesExperienceForMana() ? EXPERIENCE_FOR_MANA_TOGGLE_ON : EXPERIENCE_FOR_MANA_TOGGLE_OFF, getX(), getY(), 0, 0, 11, 6, 11, 6);
            }
        };
