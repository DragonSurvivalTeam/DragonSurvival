...
public class DragonAbilityScreen extends Screen {
    ...
    private static final ResourceLocation EXPERIENCE_FOR_MANA_TOGGLE_ON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/ability_screen/exp_conv_on.png");
    private static final ResourceLocation EXPERIENCE_FOR_MANA_TOGGLE_OFF = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/ability_screen/exp_conv_off.png");
