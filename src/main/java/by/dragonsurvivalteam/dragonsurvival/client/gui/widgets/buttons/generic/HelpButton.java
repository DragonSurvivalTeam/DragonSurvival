...
public class HelpButton extends ExtendedButton {
    private static final ResourceLocation MAIN = new ResourceLocation(MODID, "textures/gui/ability_screen/info_main.png");
    private static final ResourceLocation HOVER = new ResourceLocation(MODID, "textures/gui/ability_screen/info_hover.png");
