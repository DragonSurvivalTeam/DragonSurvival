...
public class DragonInventoryScreen extends AbstractContainerScreen<DragonContainer>
{
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        for (GuiEventListener child : children()) {
            if (child instanceof GrowthCrystalButton crystal && crystal.mouseScrolled(mouseX, mouseY, scrollX, scrollY)) {
                return true;
            }
        }
    ...
    protected void init() {
        ...
        ExtendedButton clawRenderButton = new ExtendedButton(leftPos - 30 + 7, topPos + 120 + 27, 10, 10, Component.translatable(TOGGLE_CLAWS), button -> {
            ...
            @Override
            public void extractWidgetRenderState(@NotNull final GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) { /* Texture is rendered separately */ }
        };
