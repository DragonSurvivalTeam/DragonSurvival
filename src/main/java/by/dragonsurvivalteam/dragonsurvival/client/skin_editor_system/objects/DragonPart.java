...
public record DragonPart(String key, ResourceLocation texture, List<ResourceKey<DragonSpecies>> applicableSpecies, List<ResourceKey<DragonBody>> applicableBodies, float averageHue,
                         boolean isColorable, boolean includeInRandomizer, boolean isHueRandomizable) {
