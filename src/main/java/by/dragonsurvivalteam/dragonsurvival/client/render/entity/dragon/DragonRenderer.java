...
public class DragonRenderer<R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<DragonEntity, R> {
    ...
    public static final class DragonRenderData {
        ...
        public static DragonRenderData live(
            ...
            renderData.prevXRot = doABarrelRollActive ? -player.getViewXRot(partialTick) : dragon.prevXRot;
            renderData.prevZRot = doABarrelRollActive ? DoABarrelRollCompat.getRollRadians(player, partialTick) : dragon.prevZRot;
            renderData.bodyYaw = doABarrelRollActive ? player.getViewYRot(partialTick) : movement.bodyYaw;
            renderData.headYaw = movement.headYaw;
            renderData.headPitch = movement.headPitch;
    ...
    private void setupRender(final DragonRenderData renderData, final PoseStack pose) {
        ...
        if (player != null) {
            ...
            if (climbData != null && (climbData.getClimbingType() == SyncClimbFlag.ClimbingType.CEILING || climbData.isCeilingClimbing())) {
                ...
                pose.translate(0, CeilingClimbDimensions.getUnmodifiedHeight(player) * multiplier, 0);
