 ...
 * Otherwise the model rendering will break when glow (outline render type) is present </br>
 * (Minecraft rendering cannot properly handle rendering items etc. while rendering an entity)
 */
