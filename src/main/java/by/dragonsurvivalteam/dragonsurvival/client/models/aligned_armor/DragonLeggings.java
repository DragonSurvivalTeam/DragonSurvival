...
public class DragonLeggings<T extends Entity> extends EntityModel<EntityRenderState> {
    ...
    public DragonLeggings(ModelPart root) {
        super(root);
        this.left_leg = root.createPartLookup().apply("left_leg");
        this.right_leg = root.createPartLookup().apply("right_leg");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)).mirror(false), PartPose.offset(1.9F, 12.0F, 0.0F));
        ...
        PartDefinition right_arm = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
